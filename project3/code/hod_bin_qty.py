def interface():
    print("HOD Histogram Bin Manager:")
    print("Choose how many bins you would like to for the HOD Histogram. Default value is 22 bins.")
...
def initialize_with_default_values():
    print("Initializing with the default HOD bin quantity of 22 bins.")
    bin_qty = 22
    print("")
...
def choose_bin_qty():
    ...
    if selected_method == 'y':
        ...
        print("Exiting HOD Histogram Bin Manager with default bin value.")
