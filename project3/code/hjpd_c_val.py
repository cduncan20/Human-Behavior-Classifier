def interface():
    print("HJPD Hyperparameter 'C' Manager:")
    print("Choose the 'C' value for the HJPD SVM training. 'C' must be greater than or equal to 0. Default value is 2.0.")
    c_val = choose_c_val()
    print("")
    return c_val
...
def initialize_with_default_values():
    print("Initializing with the default HJPD 'C' value of 2.0.")
    c_val= 2.0
    print("")
...
def choose_c_val():
    ...
    if selected_method == 'y':
        ...
        print("Exiting HJPD Hyperparameter 'C' Manager with default 'C' value.")
