def interface():
    print("RAD Distance Histogram Bin Manager:")
    print("Choose how many bins you would like to for the RAD Distance Histogram. Default value is 11 bins.")
...
def initialize_with_default_values():
    print("Initializing with the default RAD Distance bin quantity of 11 bins.")
    bin_qty = 11
    print("")
...
def choose_bin_qty():
    ...
    if selected_method == 'y':
        ...
        print("Exiting RAD Distance Histogram Bin Manager with default bin value.")
