def interface():
    print("RAD Hyperparameter 'C' Manager:")
    print("Choose the 'C' value for the RAD SVM training. 'C' must be greater than or equal to 0. Default value is 8.0.")
    c_val = choose_c_val()
    print("")
    return c_val
...
def initialize_with_default_values():
    print("Initializing with the default RAD 'C' value of 8.0.")
    c_val= 8.0
    print("")
...
def choose_c_val():
    ...
    if selected_method == 'y':
        ...
        print("Exiting RAD Hyperparameter 'C' Manager with default 'C' value.")
