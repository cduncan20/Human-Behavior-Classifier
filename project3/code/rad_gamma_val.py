def interface():
    print("RAD Hyperparameter 'gamma' Manager:")
    print("Choose the 'gamma' value for the RAD SVM training. Gamma must be greater than or equal to 0. Default value is 0.03125.")
    gamma = choose_gamma()
    print("")
    return gamma
...
def initialize_with_default_values():
    print("Initializing with the default RAD 'gamma' value of 0.03125.")
    gamma= 0.03125
    print("")
...
def choose_gamma():
    ...
    if selected_method == 'y':
        ...
        print("Exiting RAD Hyperparameter 'gamma' Manager with default 'gamma' value.")
